                            ...
                            ?>
                                <div class='info-product__table-container'>
                                    ...
                                    <div class='info-product__container-bottom'>
                                        ...
                                        <span class='info-product__container-new'><?= $detail['dongia'] ?> đ</span>
                                    </div>
                                </div>
                            <?php endforeach; ?>

                            <div class='info-product__table-footer'>
                                <p class='info-product__footer-top'>Thành Tiền : <span class='info-product__footer-top-money'><?= $order['total'] ?> đ</span></p>
                                <div class='info-product__footer-bottom'>
                                    ...
                                    <form method="post" action="huy-don-hang.php" class='info-product__footer-right'>
